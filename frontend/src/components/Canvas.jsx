                ...
                if (tool === "edit" && id !== -1) {
                    ...
                    if (
                        ...
                        const position = {
                            ...
                            topLeft:
                                offsetX <= rect.x + 7 && offsetY <= rect.y + 7,
                            topRight:
                                offsetX >= rect.x + rect.width - 7 &&
                                offsetY <= rect.y + 7,
                            bottomLeft:
    ...
    const handleMouseDown = useCallback(
        (event) => {
            ...
            if (tool === "edit" && id !== -1) {
                ...
                const selectedDrawing = drawingStack.find(
                    (item) => item.id == id + 1
                )
                if (selectedDrawing) {
                    console.log(id)
                ...
                if (tool === "edit" && selectedId !== null) {
                    ...
                    if (resizeHandle) {
                        ...
                        switch (resizeHandle) {
                            ...
                            case "top-left":
                                updatedRect.width =
                                    rect.width + (rect.x - offsetX) + gap // Adjusted for gap
                                updatedRect.height =
                                    rect.height + (rect.y - offsetY) + gap // Adjusted for gap
